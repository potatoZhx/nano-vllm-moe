...
#SBATCH --job-name=pre_exps_cont
#SBATCH --output=/home/mumura/moe_spec/logs/pre_exps_cont_%j.out
#SBATCH --error=/home/mumura/moe_spec/logs/pre_exps_cont_%j.err
...
echo "=== Experiment continuation start $(date -Is) ==="
echo "HOST=$(hostname)"
...
echo ""
echo "=== All remaining experiments completed $(date -Is) ==="
