...
OPTIMIZED_CONFIG_PRESETS: dict[str, dict[str, Any]] = {
    ...
    # Workload-sized best dynamic configuration.  Reclaiming enough GPU memory
    # for 14 active experts lowers expert-transfer/CPU work while 0.98 leaves
    # six 256-token KV blocks, enough for the validated 67+512-token workload.
    # Keep k2_dynamic_f16_3080 above as the full-8192-context-safe variant.
    "k2_dynamic_f16_3080_active14": {
        "allocation_modes": "profile_weighted",
        "cache_ratios": "0.109375",
        "max_draft_tokens_values": "2",
        "segment_sizes": "16",
        "verify_prefetch_max_per_boundary": 2,
        "prefetch_staging_slots_per_layer": 0,
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "K=4 low-latency settings; k2_dynamic_f16_3080 retains the full-context "
            "dynamic K1/K2 policy and k2_dynamic_f16_3080_active14 the best "
            "measured workload-sized policy; k3_3080 is the validated dual-NUMA "
